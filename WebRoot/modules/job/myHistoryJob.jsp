	...
	<body>
		...
		<d:form id="queryForm" title="我的历史作业" labelWidth="90">
			<d:line columnWidth="0.33">
			    ...
			    <d:field name="status_code" editor="combo" options="statusStore" displayField="status_name" valueField="status_code" prompt="作业状态" />
			</d:line>
			<d:line columnWidth="0.33">
		...
		<d:grid id="jobGrid" title="作业列表" height="350" selectable="true" queryForm="queryForm" queryUrl="job/jobLine.query!query_all" autoQuery="true">
			<d:toolBar>
