...
    dbfound是笔者在2011年开始起草的一个持久层框架，2012年发布1.0版本，在googlecode开源；2015年迁移到github；目前3.x系列最新版本3.6.6； 4.x系列（基于jakarta.servlet）最新版本4.3.4。
...
    近些年，随着前后端分离，dbfoundui逐步淡出。dbfound核心能力注重在后端接口的快速开发。
