...
<html>
	...
	<body>
		...
		<div style="width:220px;left:0px;top:0px;position:absolute;">
			<d:tree id="menuTree" title="树测试" bindTarget="treedata" idField="id" parentField="pid" displayField="text" height="$D.getFullHeight('menuTree')" >
		...
		<div style="margin-left:220px">
		   <d:form id="queryForm" title="角色查询" labelWidth="80">
			...
			<d:buttonGroup>
				...
				<d:button title="树刷新" click="refresh" />
			</d:buttonGroup>
			
			<d:grid id="roleGrid" title="角色列表" isCellEditable="isCellEditable" height="$D.getFullHeight('roleGrid')" queryForm="queryForm" model="sys/role" autoQuery="true" >
				<d:toolBar>
