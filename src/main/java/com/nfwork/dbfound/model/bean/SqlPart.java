...
public class SqlPart extends SqlEntity {
    ...
    public boolean isClauseCompletion() {
        return clauseCompletion;
    }

    public void setClauseCompletion(boolean clauseCompletion) {
        this.clauseCompletion = clauseCompletion;
    }
}
